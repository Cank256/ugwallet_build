...
public class LogoutTimerUtil {
    ...
    public interface LogOutListener {
        void doLogout(boolean session_timeout);
    }

    static Timer longTimer;
    static final int LOGOUT_TIME = 360000; // delay in milliseconds i.e. 5 min = 300000 ms or use timeout argument
